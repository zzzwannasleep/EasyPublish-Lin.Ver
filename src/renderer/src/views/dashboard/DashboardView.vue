    ...
    <div class="flex min-h-full flex-col gap-4">
      <section class="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        <article v-for="card in statCards" :key="card.key" class="surface-tile px-4 py-4">
          ...
          <div
            class="mt-2 font-display text-[1.7rem] leading-none tracking-[-0.04em] text-copy-primary"
          >
            {{ card.value }}
          </div>
        </article>
        ...
        <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          ...
          >
            <div class="flex min-w-0 items-center gap-3">
              ...
              <h3
                class="truncate font-display text-[1.05rem] leading-tight tracking-[-0.03em] text-copy-primary"
              >
                {{ link.title }}
              </h3>
            </div>
            ...
            <span
              class="text-[12px] font-medium text-copy-secondary transition group-hover:text-brand"
            >
