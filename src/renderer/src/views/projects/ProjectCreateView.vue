  ...
  <div class="project-create-page">
    ...
    >
      <template #utility>
        <button
          :class="[
            ...
            chrome.activeToolbarMenu === 'proxy' ? 'project-create-page__utility-button is-active' : 'text-copy-secondary',
          ]"
          type="button"
      ...
      <template #utility-panel>
        <el-form :model="chrome.proxyForm" label-position="top" class="project-create-page__proxy-form">
          ...
          <el-form-item class="project-create-page__proxy-actions">
    ...
    <main class="project-create-page__main">
...
.project-create-page__utility-button.is-active {
  border-color: var(--border-strong);
  background: var(--surface-brand-fill);
  color: var(--text-primary);
}

.project-create-page__proxy-form :deep(.el-form-item) {
  margin-bottom: 14px;
}

.project-create-page__proxy-actions {
  margin-bottom: 0;
}
</style>
