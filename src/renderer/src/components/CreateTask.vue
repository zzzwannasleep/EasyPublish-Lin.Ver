...
import { Collection, Document, Files, FolderOpened, Grid, Promotion } from '@element-plus/icons-vue'
    ...
    <el-form ref="createForm" :model="form" :rules="rules" label-position="top" class="create-project__form">
      ...
      <section class="create-project__actions">
        <div class="create-project__actions-copy">
          ...
          <div class="create-project__actions-text">{{ t('projectCreate.hero.summary') }}</div>
        </div>
        <el-button
          type="primary"
          size="large"
