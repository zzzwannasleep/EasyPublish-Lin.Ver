...
type ProjectHandlers = {
  ...
  saveSeriesWorkspaceSettings: (msg: string) => Asyncish<unknown>
  createSeriesEpisode: (msg: string) => Asyncish<unknown>
  createSeriesVariant: (msg: string) => Asyncish<unknown>
  batchCreateSeriesVariants: (msg: string) => Asyncish<unknown>
  saveSeriesPublishProfile: (msg: string) => Asyncish<unknown>
  importSeriesPublishProfile: (msg: string) => Asyncish<unknown>
  exportSeriesPublishProfile: (msg: string) => Asyncish<unknown>
  removeSeriesPublishProfile: (msg: string) => Asyncish<unknown>
...
export function registerIpcHandlers({ Global, BT, Forum, Project, Site, Log, Task }: IpcHandlerRegistry): void {
  ...
  ipcMain.handle('project_saveSeriesWorkspaceSettings', (_event, msg) => Project.saveSeriesWorkspaceSettings(msg))
  ...
  ipcMain.handle('project_batchCreateSeriesVariants', (_event, msg) => Project.batchCreateSeriesVariants(msg))
  ipcMain.handle('project_saveSeriesPublishProfile', (_event, msg) => Project.saveSeriesPublishProfile(msg))
  ipcMain.handle('project_importSeriesPublishProfile', (_event, msg) => Project.importSeriesPublishProfile(msg))
  ipcMain.handle('project_exportSeriesPublishProfile', (_event, msg) => Project.exportSeriesPublishProfile(msg))
  ipcMain.handle('project_removeSeriesPublishProfile', (_event, msg) => Project.removeSeriesPublishProfile(msg))
